            ...
            <div >
                <div class=" align-items-center">
                    <div class="row">
                        ...
                        <div style="width: 50%;padding-top:2rem;padding-left:22rem;" class="column"><a href='{{route('admin.blog.add')}}' style="font-family: 'Times New Roman', Times, serif;font-style:bold;color:white;font-size:20px;cursor:pointer;" class="btn btn-success" >ADD NEW BLOG</a></div>
                    </div>
                </div>
            </div>
            <hr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="font-family: 'Times New Roman', Times, serif;font-size:18px;width:15%">
                                <a href='{{route('admin.blog.delete',$b->id)}}' style="font-family: 'Times New Roman', Times, serif;font-style:bold;color:white;font-size:20px;cursor:pointer;" class="btn btn-danger" >DELETE</a>
                            </td>
                        </tr>
                    </tbody>
                    @endforeach
