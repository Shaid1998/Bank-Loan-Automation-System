                ...
                <table class="table align-middle mb-0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="font-family: 'Times New Roman', Times, serif;font-size:18px;width:5%">{{$m->Loan_id}}</td>
                            ...
                            <td style="font-family: 'Times New Roman', Times, serif;font-size:18px;width:4%">{{$m->loan_duration}}</td>
