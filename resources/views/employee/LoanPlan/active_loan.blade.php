			...
			<table class="table align-middle mb-0">
				<thead class="table-light">
					<tr>
						...
						<th style="font-family: 'Times New Roman', Times, serif;font-size:15px;text-align:center;width:5%;">Plan</th>
						...
						<th style="font-family: 'Times New Roman', Times, serif;font-size:15px;text-align:center;width:10%;">User Address</th> 
						<th style="font-family: 'Times New Roman', Times, serif;font-size:15px;text-align:center;width:5%;">User Phone</th> 
						<th style="font-family: 'Times New Roman', Times, serif;font-size:15px;text-align:center;width:5%;">User Email</th> 
						...
						<th style="font-family: 'Times New Roman', Times, serif;font-size:15px;text-align:center;width:5%;">Commitment</th> 
					...
					<tbody>
						<tr>
							...
							<td style="font-family: 'Times New Roman', Times, serif;font-size:15px;font-weight:300;width:5%;text-align:center;">{{$request->plan_id}}</td>
                            ...
                            <td style="font-family: 'Times New Roman', Times, serif;font-size:15px;font-weight:300;width:10%;text-align:center;">{{$request->user_address}}</td>
                            <td style="font-family: 'Times New Roman', Times, serif;font-size:15px;font-weight:300;width:5%;text-align:center;">{{$request->user_phone}}</td>
                            <td style="font-family: 'Times New Roman', Times, serif;font-size:15px;font-weight:300;width:5%;text-align:center;">{{$request->user_email}}</td>
							...
							<td style="font-family: 'Times New Roman', Times, serif;font-size:15px;font-weight:300;width:25%;text-align:center;">
								...
								<a href='{{ route ('employee.active.loan.delete',$request->id)}}'style="font-family: 'Times New Roman', Times, serif;font-style:bold;font-size:15px;cursor:pointer;color:white;" id="delete" class="btn btn-danger" >DELETE</a>
							</td>
						</tr>
					</tbody>
					@endforeach
