...
<div style="background-image: linear-gradient(to bottom right, rgb(68, 0, 255), rgb(0, 255, 26))" class="page-content">
    ...
    <div class="row">
        ...
        <div style="padding-left: 2rem;padding-right:1rem;padding-top:2rem;padding-bottom:3rem" class="row">
            <div style="width: 50%;padding-left: 1rem;padding-right:1rem" class="column"><a style="width: 95%;font-size:40px;border:0;border-radius:55px;" class="btn btn-primary">APPLY</a></div>
            <div style="width: 50%;padding-left: 1rem;padding-right:1rem" class="column"><a style="width: 95%;font-size:40px;border:0;border-radius:55px;"  class="btn btn-warning">INQUIRY</a></div>
        </div>
    </div>
