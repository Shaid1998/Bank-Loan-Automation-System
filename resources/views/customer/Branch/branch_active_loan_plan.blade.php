                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="font-family: 'Times New Roman', Times, serif;font-size:18px;width:30%;text-align:center;">
                                <a href='{{route('admin.send.message',$m->id)}}' style="font-family: 'Times New Roman', Times, serif;font-style:bold;color:white;font-size:20px;cursor:pointer;" class="btn btn-primary" >INFO</a>
